                    ...
                    <form method="POST" action="{{ route('usuarios.update', $usuario) }}" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="password"
                                    class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                                    {{ __('Nueva contraseña') }} <span
                                        class="text-gray-400">({{ __('opcional') }})</span>
                                </label>
                                <div class="relative">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" id="rfc" name="rfc"
                                    value="{{ old('rfc', $usuario->rfc) }}" maxlength="14" placeholder="ABCD123456EFG"
                                    class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-gray-100">
                                @error('rfc')
                                    <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" id="curp" name="curp"
                                    value="{{ old('curp', $usuario->curp) }}" maxlength="19" minlength="10"
                                    placeholder="ABCD123456HDFGHG01"
                                    class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-gray-100">
                                @error('curp')
                                    <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select id="sexo" name="sexo"
                                    ...
                                    <option value="masculino"
                                        {{ old('sexo', $usuario->sexo) == 'masculino' ? 'selected' : '' }}>
                                        {{ __('Masculino') }}</option>
                                    <option value="femenino"
                                        {{ old('sexo', $usuario->sexo) == 'femenino' ? 'selected' : '' }}>
                                        {{ __('Femenino') }}</option>
                                </select>
                                @error('sexo')
                                    <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select id="theme" name="theme"
                                    class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-gray-100">
                                    <option value="light"
                                        {{ old('theme', $usuario->theme) == 'light' ? 'selected' : '' }}>
                                        {{ __('Claro') }}</option>
                                    <option value="dark"
                                        {{ old('theme', $usuario->theme) == 'dark' ? 'selected' : '' }}>
                                        {{ __('Oscuro') }}</option>
                                </select>
                                @error('theme')
                                    <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select id="estatus" name="estatus"
                                    class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-gray-100">
                                    <option value="1"
                                        {{ old('estatus', $usuario->estatus) == 1 ? 'selected' : '' }}>
                                        {{ __('Activo') }}</option>
                                    <option value="0"
                                        {{ old('estatus', $usuario->estatus) == 0 ? 'selected' : '' }}>
                                        {{ __('Inactivo') }}</option>
                                </select>
                                @error('estatus')
                                    <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
