                            ...
                            <div>
                                ...
                                <select id="puesto" name="puesto"
                                    ...
                                    <option value="ADMINISTRATIVO"
                                        {{ old('puesto') == 'ADMINISTRATIVO' ? 'selected' : '' }}>
                                        {{ __('Administrativo') }}</option>
                                    <option value="ATP" {{ old('puesto') == 'ATP' ? 'selected' : '' }}>
                                        {{ __('ATP') }}</option>
                                    ...
                                    <option value="DIRECTOR" {{ old('puesto') == 'DIRECTOR' ? 'selected' : '' }}>
                                        {{ __('Director') }}</option>
                                    <option value="DOCENTE" {{ old('puesto') == 'DOCENTE' ? 'selected' : '' }}>
                                        {{ __('Docente') }}</option>
                                    ...
                                    <option value="SUBDIRECTOR"
                                        {{ old('puesto') == 'SUBDIRECTOR' ? 'selected' : '' }}>
                                        {{ __('Subdirector') }}</option>
                                    <option value="TRABAJO SOCIAL"
                                        {{ old('puesto') == 'TRABAJO SOCIAL' ? 'selected' : '' }}>
                                        {{ __('Trabajo Social') }}</option>
                                    <option value="USAER" {{ old('puesto') == 'USAER' ? 'selected' : '' }}>
                                        {{ __('USAER') }}</option>
                                    <option value="VELADOR" {{ old('puesto') == 'VELADOR' ? 'selected' : '' }}>
                                        {{ __('Velador') }}</option>
                                </select>
                                @error('puesto')
                                    <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
