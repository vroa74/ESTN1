                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-input id="matricula" type="text" name="matricula" :value="old('matricula', $student->matricula)"
                                ...
                                <div>
                                    ...
                                    <x-input id="grado" type="number" name="grado" :value="old('grado', $student->grado)"
                                ...
                                <div>
                                    ...
                                    <select id="grupo" name="grupo"
                                        ...
                                        @foreach (['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L'] as $grupo)
                                            <option value="{{ $grupo }}"
                                                {{ old('grupo', $student->grupo) == $grupo ? 'selected' : '' }}>
                                                {{ $grupo }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <x-input id="Fnom" type="text" name="Fnom" :value="old('Fnom', $student->Fnom)"
                                        class="mt-1 block w-full" />
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-input id="nombres" type="text" name="nombres" :value="old('nombres', $student->nombres)"
                                        class="mt-1 block w-full" />
                                ...
                                <div>
                                    ...
                                    <x-input id="apa" type="text" name="apa" :value="old('apa', $student->apa)"
                                        class="mt-1 block w-full" />
                                ...
                                <div>
                                    ...
                                    <x-input id="ama" type="text" name="ama" :value="old('ama', $student->ama)"
                                        class="mt-1 block w-full" />
                                ...
                                <div>
                                    ...
                                    <x-input id="fnac" type="date" name="fnac" :value="old('fnac', $student->fnac ? $student->fnac->format('Y-m-d') : '')"
                                        class="mt-1 block w-full" />
                                ...
                                <div>
                                    ...
                                    <x-input id="curp" type="text" name="curp" :value="old('curp', $student->curp)"
                                ...
                                <div>
                                    ...
                                    <select id="sexo" name="sexo"
                                        ...
                                        required>
                                        <option value="F"
                                            {{ old('sexo', $student->sexo) == 'F' ? 'selected' : '' }}>Femenino
                                        </option>
                                        <option value="M"
                                            {{ old('sexo', $student->sexo) == 'M' ? 'selected' : '' }}>Masculino
                                        </option>
                                    </select>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-input id="email" type="email" name="email" :value="old('email', $student->email)"
                                        class="mt-1 block w-full" />
                                ...
                                <div>
                                    ...
                                    <x-input id="telefono" type="text" name="telefono" :value="old('telefono', $student->telefono)"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="estatus" name="estatus"
                                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                        <option value="activo"
                                            {{ old('estatus', $student->estatus) == 'activo' ? 'selected' : '' }}>
                                            Activo</option>
                                        <option value="inactivo"
                                            {{ old('estatus', $student->estatus) == 'inactivo' ? 'selected' : '' }}>
                                            Inactivo</option>
                                        <option value="egresado"
                                            {{ old('estatus', $student->estatus) == 'egresado' ? 'selected' : '' }}>
                                            Egresado</option>
                                        <option value="baja"
                                            {{ old('estatus', $student->estatus) == 'baja' ? 'selected' : '' }}>Baja
                                        </option>
                                    </select>
                            ...
                            <div class="mt-4">
                                ...
                                <textarea id="observaciones" name="observaciones" rows="3"
                                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('observaciones', $student->observaciones) }}</textarea>
