                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-input id="matricula" type="text" name="matricula" :value="old('matricula')"
                                ...
                                <div>
                                    ...
                                    <x-input id="grado" type="number" name="grado" :value="old('grado')"
                                ...
                                <div>
                                    ...
                                    <x-input id="Fnom" type="text" name="Fnom" :value="old('Fnom')"
                                        class="mt-1 block w-full" />
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-input id="nombres" type="text" name="nombres" :value="old('nombres')"
                                        class="mt-1 block w-full" />
                                ...
                                <div>
                                    ...
                                    <x-input id="apa" type="text" name="apa" :value="old('apa')"
                                        class="mt-1 block w-full" />
                                ...
                                <div>
                                    ...
                                    <x-input id="ama" type="text" name="ama" :value="old('ama')"
                                        class="mt-1 block w-full" />
                                ...
                                <div>
                                    ...
                                    <x-input id="fnac" type="date" name="fnac" :value="old('fnac')"
                                        class="mt-1 block w-full" />
                                ...
                                <div>
                                    ...
                                    <x-input id="curp" type="text" name="curp" :value="old('curp')"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-input id="telefono" type="text" name="telefono" :value="old('telefono')"
