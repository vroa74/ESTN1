<x-app-layout>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="md:col-span-2">
                                    ...
                                    <div id="selected-profesor"
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <button type="button" onclick="clearSelectedProfesor()"
                                                class="text-violet-500 hover:text-violet-700 dark:text-violet-400 dark:hover:text-violet-200">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <!-- Botón para abrir modal -->
                                    <button type="button" id="select-profesor-btn" onclick="openProfesorModal()"
                                        class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-gray-100 text-left bg-white hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <span
                                ...
                                <div>
                                    ...
                                    <input type="hidden" id="trabajo_social_id" name="trabajo_social_id"
                                        value="{{ old('trabajo_social_id') }}">
        ...
        <div
            ...
            <div class="mt-3">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button type="button" onclick="closeProfesorModal()"
                        class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M6 18L18 6M6 6l12 12"></path>
                ...
                <div class="mb-4">
                    <div>
                        ...
                        <input type="text" id="search-profesor-name" placeholder="Nombre del docente..."
                            class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-gray-100">
                    </div>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody id="profesores-table-body"
            ...
            <div class="mt-3">
                ...
                <div class="mb-4">
                    <div>
                        ...
                        <input type="text" id="search-prefecto-name" placeholder="Nombre del prefecto..."
                            class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-gray-100">
                    </div>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody id="prefectos-table-body"
                            class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <!-- Los prefectos se cargarán aquí -->
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <div class="mt-3">
                ...
                <div class="mb-4">
                    <div>
                        ...
                        <input type="text" id="search-trabajador-social-name"
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody id="trabajadores-sociales-table-body"
                            class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <!-- Los trabajadores sociales se cargarán aquí -->
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    <script>
        ...
        // Variable global para rastrear el tipo de modal activo (ya no se usa)

        // Funciones para Profesor
        function openProfesorModal() {
            document.getElementById('profesor-modal').classList.remove('hidden');
            loadProfesores();
        }

        function closeProfesorModal() {
            document.getElementById('profesor-modal').classList.add('hidden');
        }

        function loadProfesores() {
            const name = document.getElementById('search-profesor-name').value;
            ...
            loadUsuariosFromModal(params, 'profesores-table-body', 'docentes');
        }

        function selectProfesor(profesorId, profesorNombre, profesorEmail, profesorPuesto) {
            selectUsuarioFromModal(profesorId, profesorNombre, profesorEmail, profesorPuesto, 'profesor');
        }

        function clearSelectedProfesor() {
            clearSelectedUsuario('profesor');
        }

        // Funciones para Prefecto
        ...
        function loadPrefectos() {
            const name = document.getElementById('search-prefecto-name').value;
            ...
            loadUsuariosFromModal(params, 'prefectos-table-body', 'prefectos');
        }

        function selectPrefecto(prefectoId, prefectoNombre, prefectoEmail, prefectoPuesto) {
            selectUsuarioFromModal(prefectoId, prefectoNombre, prefectoEmail, prefectoPuesto, 'prefecto');
        }

        function clearSelectedPrefecto() {
            clearSelectedUsuario('prefecto');
        }

        // Funciones para Trabajador Social
        ...
        function loadTrabajadoresSociales() {
            const name = document.getElementById('search-trabajador-social-name').value;
            ...
            loadUsuariosFromModal(params, 'trabajadores-sociales-table-body', 'trabajadores sociales');
        }

        function selectTrabajadorSocial(trabajadorId, trabajadorNombre, trabajadorEmail, trabajadorPuesto) {
            selectUsuarioFromModal(trabajadorId, trabajadorNombre, trabajadorEmail, trabajadorPuesto, 'trabajador_social');
        }

        function clearSelectedTrabajadorSocial() {
            clearSelectedUsuario('trabajador_social');
        }

        // Funciones genéricas para manejar usuarios
        function loadUsuariosFromModal(params, tableBodyId, loadingText) {
                ...
                <tr>
                    <td colspan="4" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                        <div class="flex items-center justify-center">
                            ...
                            Cargando ${loadingText}...
                        </div>
                    </td>
                </tr>
            `;

            const url = `/usuarios/search?${params}`;
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    if (tbody && tbody.innerHTML.trim() !== '') {
                        document.getElementById(tableBodyId).innerHTML = tbody.innerHTML;
                    } else {
                        document.getElementById(tableBodyId).innerHTML = `
                            <tr>
                                <td colspan="4" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                    No se encontraron ${loadingText}.
                                </td>
                            </tr>
                        `;
                    }
        ...
        function selectUsuarioDirect(usuarioId, usuarioNombre, usuarioEmail, usuarioPuesto) {
            // Determinar qué modal está abierto
            let tipo = null;
            if (!document.getElementById('profesor-modal').classList.contains('hidden')) {
                tipo = 'profesor';
            } else if (!document.getElementById('prefecto-modal').classList.contains('hidden')) {
                tipo = 'prefecto';
            } else if (!document.getElementById('trabajador-social-modal').classList.contains('hidden')) {
                tipo = 'trabajador_social';
            }
            ...
            const tipoConfig = {
                'profesor': {
                    inputId: 'profesor_id',
                    nameId: 'profesor-name',
                    infoId: 'profesor-info',
                    selectedId: 'selected-profesor',
                    buttonId: 'select-profesor-btn',
                    closeFunction: 'closeProfesorModal'
                },
                'prefecto': {
                    inputId: 'prefecto_id',
                    nameId: 'prefecto-name',
                    infoId: 'prefecto-info',
                    selectedId: 'selected-prefecto',
                    buttonId: 'select-prefecto-btn',
                    closeFunction: 'closePrefectoModal'
                },
                'trabajador_social': {
                    inputId: 'trabajo_social_id',
                    nameId: 'trabajador-social-name',
                    infoId: 'trabajador-social-info',
                    selectedId: 'selected-trabajador-social',
                    buttonId: 'select-trabajador-social-btn',
                    closeFunction: 'closeTrabajadorSocialModal'
                }
            };

            const config = tipoConfig[tipo];
            if (config) {
                document.getElementById(config.inputId).value = usuarioId;
                document.getElementById(config.nameId).textContent = usuarioNombre;
                document.getElementById(config.infoId).textContent = `${usuarioPuesto} - ${usuarioEmail}`;
                document.getElementById(config.selectedId).classList.remove('hidden');
                document.getElementById(config.buttonId).style.display = 'none';

                // Cerrar el modal correspondiente
                window[config.closeFunction]();
            } else {
                console.error('No se pudo determinar el tipo de modal');
            }
        }

        function clearSelectedUsuario(tipo) {
            const tipoConfig = {
                'profesor': {
                    inputId: 'profesor_id',
                    selectedId: 'selected-profesor',
            ...
            if (config) {
                ...
                document.getElementById(config.selectedId).classList.add('hidden');
                document.getElementById(config.buttonId).style.display = 'block';
            }
        }

        // Event listeners para los nuevos filtros
        document.getElementById('search-profesor-name').addEventListener('input', loadProfesores);
        document.getElementById('search-prefecto-name').addEventListener('input', loadPrefectos);
        document.getElementById('search-trabajador-social-name').addEventListener('input', loadTrabajadoresSociales);
        ...
        document.getElementById('profesor-modal').addEventListener('click', function(e) {
            if (e.target === this) {
                closeProfesorModal();
            }
        });
