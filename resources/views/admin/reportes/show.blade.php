                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Creado el {{ $reporte->created_at->format('d/m/Y H:i:s') }}
                            </p>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                            ...
                            <dl class="space-y-3">
                                <div>
                                    ...
                                    <dd class="text-sm text-gray-900 dark:text-gray-100">
                                        {{ $reporte->fecha_reporte->format('d/m/Y') }}</dd>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <dd class="text-sm text-gray-900 dark:text-gray-100">{{ $reporte->profesor->name }}
                                    </dd>
                                </div>
                                <div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                                <dl class="space-y-3">
                                    @if ($reporte->prefecto)
                                        <div>
                                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Firmado por
                                                Prefecto</dt>
                                            <dd class="text-sm text-gray-900 dark:text-gray-100">
